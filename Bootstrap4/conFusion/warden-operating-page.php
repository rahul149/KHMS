<?php 
    ...
    }else{ header("Location: /khms/Kitt-management-site/Bootstrap4/conFusion/mainpage.php");}
...
<br><br><br><br><br>
    ...
    <div class="container warden-side-complaint-table my-5 ">
        <table class="table table-responsive" id="myTable">
            <thead>
                <tr>
                    <th scope="col">S.No</th>
                    <th scope="col">Student's Complaints</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST"
                        action="/khms/Kitt-management-site/Bootstrap4/conFusion/warden-operating-page.php?userid=<?php echo $_userid; ?>">
    ...
    Array.from(comp).forEach((element) => {
        element.addEventListener("click", (e) => {
            ...
            console.log("uid", uid);
            if (confirm("Are you sure you want to mark it as completed!")) {
                console.log("yes");
                window.location =
    ...
    <script src="js/warden-operating-page.js"></script>
</body>
