...
<body>
    ...
    <strong>Failed!</strong> Your account could not be created. ".$_GET["error"]."
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
      <span aria-hidden='true'>×</span>
    </button>
  </div>";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Signup to KHMS</h5>
                ...
                <form action="\khms\Kitt-management-site\Bootstrap4\conFusion\partials\_handlesingup.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="signmail" name="signmail"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
    ...
    <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand mr-auto" href="./Mainpage.php"> <img src="LunaPic-Edit-7.PNG" class="img-fluid mr-5"
    ...
    <div class="bg-image">
        <div class="text-center">
            <img src="https://cdn.kiit.ac.in/wp-content/uploads/2018/04/KIIT-Logo-side-w1600.png" class="img-fluid"
        ...
        <div class="form-box mx-auto d-block mb-5">
            <form action="partials/_handlelogin.php" method="POST">
                ...
                <div class="for-box">
                    ...
                    <small id="emailHelp" class="form-text text-white">New here?<a href="#signupModal" data-toggle="modal"> Create
                            an account</a></small>
                    <div class="row justify-content-center mt-5">
                        ...
                        <div class="col-4 mx-5 order-1 order-md-2">
                            <button class="btn btn-primary ml-5 btn-lg" id="btn-2" role="button">login</button>
                        </div>
                    </div>
                </div>
            </form>
